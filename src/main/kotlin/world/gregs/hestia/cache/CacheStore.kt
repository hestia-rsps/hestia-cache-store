package world.gregs.hestia.cache

import world.gregs.hestia.cache.crypto.Rsa
import world.gregs.hestia.cache.crypto.Whirlpool
import world.gregs.hestia.cache.store.Index
import world.gregs.hestia.cache.store.Store
...
class CacheStore @Throws(IllegalArgumentException::class) constructor(path: String, modulus: BigInteger, private: BigInteger) :
    Cache {
